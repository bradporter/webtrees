...
class GedcomElementFactory implements GedcomElementFactoryInterface
{
    ...
    public function __construct()
    {
        ...
        $this->elements = [
            ...
            'INDI:*:PLAC:MAP'          => new EmptyElement(I18N::translate('Map')),
            'INDI:*:PLAC:MAP:LATI'     => new PlaceHierarchy(I18N::translate('Latitude')),
            'INDI:*:PLAC:MAP:LONG'     => new PlaceHierarchy(I18N::translate('Longitude')),
            ...
            'FAM:*:HUSB:AGE'          => new AgeAtEvent(I18N::translate('Age')),
            'FAM:*:NOTE'              => new NoteStructure(I18N::translate('Note')),
            ...
            'FAM:*:PLAC:MAP'          => new EmptyElement(I18N::translate('Map')),
            'FAM:*:PLAC:MAP:LATI'     => new PlaceHierarchy(I18N::translate('Latitude')),
            'FAM:*:PLAC:MAP:LONG'     => new PlaceHierarchy(I18N::translate('Longitude')),
            ...
            'FAM:*:WIFE:AGE'          => new AgeAtEvent(I18N::translate('Age')),
    ...
    public function make(string $tag): GedcomElementInterface
    {
        return
            $this->elements[$tag] ??
            $this->findElementByWildcard($tag) ??
            $this->findElementInIncorrectContext($tag) ??
     ...
     * @return GedcomElementInterface|null
     */
    private function findElementInIncorrectContext(string $tag): ?GedcomElementInterface
    {
        foreach ($this->elements as $tags => $element) {
            if (Str::endsWith($tags, $tag)) {
                return $element;
            }
        }
