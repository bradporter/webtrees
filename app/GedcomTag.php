...
class GedcomTag
{
    ...
    {
        return !Factory::gedcomElement()->make($tag) instanceof UnknownElement;
    }
    ...
    {
        return Factory::gedcomElement()->make($tag)->label();
    }
    ...
    {
        return Factory::gedcomElement()->make('INDI:_UID')->default();
    }
}
